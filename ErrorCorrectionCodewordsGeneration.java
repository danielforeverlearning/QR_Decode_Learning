...
int[] Table_Exponent_Of_Alpha_To_Integer = { 1,     2,   4,   8,  16,  32,  64, 128,  29,  58, 116, 232, 205, 135,  19,  38,
...
public static void Make_Table_Exponent_Of_Alpha_To_Integer()
{
	int[] GF256_array = new int[256];
	int temp;
	...
	{ 
        if (ii <= 15)
	         System.out.print(GF256_array[ii] + ", ");
		else if (ii % 16 == 0)
		{
			 System.out.println();
			 System.out.print(GF256_array[ii] + ", ");
...
}//Make_Table_Exponent_Of_Alpha_To_Integer
