...
public class RowColumnMapReader {
	...
	public void Change_3FindersToA_TimingToZ_AlignmentToZ(int version)
	{
		//top left 9x9
	...
	}//Change_3FindersToA_TimingToZ_AlignmentToZ
	...
	public void Find_DC_And_ECC_FromMap(int totalCodewords)
	{	
		mybyte.clear();
		codewords.clear();
