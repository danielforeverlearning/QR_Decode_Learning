...
public class DidNotWorkGF256_Berlekamp_Welch_algorithm {
    ...
    public DidNotWorkGF256_Berlekamp_Welch_algorithm(int gf_val, int[] temp_b, int temp_e_count) throws  Exception
    {
        GF = gf_val;
